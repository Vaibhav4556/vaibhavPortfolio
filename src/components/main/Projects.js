	...
	const projectList = [
		{
			...
			whatnext: ['To add more feature like notes and study material for subjects'],
		...
		},
		{
			...
			whatnext: ['To add admin pannel to make note  delivered and undelivered pizza, integrate with the payment gateway'],
			imgSrc: [home,cart],
			techStack: [
				reacticon,
				materialuiicon,
		...
		},
		{
			...
			about:
				'This web app is used to create, update, delete the student entry in the dashboard. It will helpfull for storing the data related to any person and we can update it at at time to time',
			why: "As my father is teacher it is very helpfull to maintain the data for the students in the class",
			whatnext: [],
			imgSrc: [createStudent,create1],
			techStack: [javascripticon, bootstrapicon, netlifyicon],
			credentials: [],
			github: 'https://github.com/Vaibhav4556/Admin_Dashboard',
			live: 'https://famous-sorbet-7a9716.netlify.app/',
			bg: primary,
			text: secondary,
			heading: bg,
		},
					...
					<div className="project-withsvg" key={index} style={{ backgroundColor: bg }}>
						<div className="container-sm project">
							...
							<div className="project-img" >
								{imgSrc.map((e, index) => (
									<img alt="broken" className={'Layer-' + index + name} src={e} key={index} style={{width:"400px"}}  />
