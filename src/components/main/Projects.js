  ...
  const projectList = [
    {
      ...
      live: "https://resultmanagement.onrender.com/",
      bg: tertiary,
      text: secondary,
      heading: primary,
    },
    ...
    
    {
      name: "EASYCHAT APP",
      about:
        "Working with socket IO , One to one coversation, Real time messaging with the socket rooms, Real time notifications for message",
      whatnext: [
        "To add extra features like to create personalised groups",
      ],
      imgSrc: [ home,cart],
      techStack: [
        reacticon,
      ...
      github: "https://github.com/Vaibhav4556/easychat-iosocket",
      live: "https://easychat.onrender.com/login",
      bg: primary,
      text: secondary,
      heading: tertiary,
    },
    ...
    },
    {
      ...
      live: "https://track-expense-app.onrender.com/login",
      bg: primary,
      text: secondary,
      heading: bg,
    },
