...
function Footer() {
	...
	const mediaList = [
		{
			name: 'Github',
			link: 'https://github.com/Vaibhav4556',
			other: <GrGithub />,
		},
		{
			name: 'Linkedin',
			link: 'https://www.linkedin.com/in/vaibhav-burde-394121120/',
			other: <GrLinkedin />,
		},
		{
			name: 'sonuburde@gmail.com',
			link: 'sonuburde@gmail.com',
			other: <GrMail />,
		},
	];
	...
	return (
		<footer className="footer-wrapper" style={bgStyle}>
			...
			Copyright © 2022 Vaibhav V Burde
		</footer>
	);
}
